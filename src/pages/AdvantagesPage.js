...
import "../styles/AdvantagesPage.css";
import AdvantageParagraph from "../components/AdvantageParagraph";
...
function AdvantagesPage() {
  ...
  return (
    <div className="advantages-page">
      {navbarDisplay ? <Navbar lightMode={true} /> : <NavbarContainer lightMode={true} />}
